#!/usr/bin/env python3
"""
Check maze model configurations for consistency
"""
...
def check_all_maze_configurations():
    """Check all maze configurations for consistency"""
    
    print("="*80)
    print("MAZE CONFIGURATION CONSISTENCY CHECK")
    print("="*80)
    ...
    print(f"Consistent models: {consistent_models}")
    print(f"Consistency rate: {consistent_models/total_models*100:.1f}%")
...
if __name__ == "__main__":
    print("Checking maze configurations...")
    is_consistent = check_all_maze_configurations()
