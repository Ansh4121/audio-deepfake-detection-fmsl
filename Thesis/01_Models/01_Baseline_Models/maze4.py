#!/usr/bin/env python3
# ===================================================================
# maze4.py - Model 4: RawNetSinc with SpecAugment
# 
# DESCRIPTION:
# This model uses trainable SincConv filters with SE blocks and SpecAugment
# for improved generalization. This establishes the baseline for models
# with trainable filters and data augmentation.
# 
# STANDARDIZATION:
...
# ===================================================================
# Part 1: Model Definition (Model 4 - RawNetSinc + SpecAugment)
# ===================================================================
...
class Model4_RawNetSinc_SpecAugment(nn.Module):
    def __init__(self, d_args, device):
        super(Model4_RawNetSinc_SpecAugment, self).__init__()
        self.device = device
        ...
        # SpecAugment for raw audio (if enabled)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Maze4: RawNetSinc with SpecAugment')
    ...
    parser.add_argument('--comment', type=str, default="Real_Maze_4", help='Comment for model directory')
    ...
    # Initialize model
    model = Model4_RawNetSinc_SpecAugment(model_config['model'], device)
    if args.model_path:
