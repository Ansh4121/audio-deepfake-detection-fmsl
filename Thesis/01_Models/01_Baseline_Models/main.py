...
if __name__ == '__main__':
    ...
    # Dataset
    parser.add_argument('--database_path', type=str, default='/content/sample_data/data/', help='Root path of database (use local path for efficiency). We assume that all three ASVspoof 2019 LA train, LA dev and ASVspoof2021 LA eval data folders are in the same database_path directory.')
    '''
    % database_path/
    %   |- LA
    ...
    model_tag = 'Real_Maze_main_{}_{}_{}_{}_{}'.format(
    ...
    print(f'✅ Training completed! Best model (epoch {best_epoch}) saved to: {model_save_path}')
