#!/usr/bin/env python3
# ===================================================================
# maze5.py - Model 5: RawNetSinc with SpecAugment and Focal Loss
# 
# DESCRIPTION:
# This model extends Model 4 with Focal Loss for better handling of
# class imbalance. This establishes the baseline for models with
...
# ===================================================================
# Part 1: Model Definition (Model 5 - RawNetSinc + SpecAugment + Focal Loss)
# ===================================================================
...
class Model5_RawNetSinc_SpecAugment_FocalLoss(nn.Module):
    def __init__(self, d_args, device):
        super(Model5_RawNetSinc_SpecAugment_FocalLoss, self).__init__()
        self.device = device
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Maze5: RawNetSinc with SpecAugment and Focal Loss')
    ...
    parser.add_argument('--comment', type=str, default="Real_Maze_5", help='Comment for model directory')
    ...
    # Initialize model
    model = Model5_RawNetSinc_SpecAugment_FocalLoss(model_config['model'], device)
    if args.model_path:
    ...
    # Loss function - Focal Loss is the key innovation here
    if args.loss == 'focal':
