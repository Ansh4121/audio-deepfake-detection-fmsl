...
The code and figures used in this thesis are available in the accompanying GitHub repository. Replace \texttt{<USER>} and \texttt{<REPO>} with the actual GitHub username and repository name.

\begin{itemize}
\item \textbf{Repository (root):} \url{https://github.com/<USER>/<REPO>}
\item \textbf{Evaluation scripts:} \url{https://github.com/<USER>/<REPO>/tree/main/Thesis/02_Evaluation_Scripts}
\item \textbf{Baseline models:} \url{https://github.com/<USER>/<REPO>/tree/main/Thesis/01_Models/01_Baseline_Models}
\item \textbf{FMSL-enhanced models:} \url{https://github.com/<USER>/<REPO>/tree/main/Thesis/01_Models/02_FMSL_Enhanced_Models}
\item \textbf{Thesis figures (all PNGs used in the thesis):} \url{https://github.com/<USER>/<REPO>/tree/main/WUT-Thesis/img}
\item \textbf{Configuration files:} \url{https://github.com/<USER>/<REPO>/tree/main/Thesis/07_Configuration_Files}
\end{itemize}
...
All figures are in the repository at: \url{https://github.com/<USER>/<REPO>/tree/main/WUT-Thesis/img}. Direct links (replace \texttt{<USER>} and \texttt{<REPO>}): e.g.\ \url{https://github.com/<USER>/<REPO>/blob/main/WUT-Thesis/img/maze_models_comparison.png}.
